...
class ItemServiceTest {
    ...
    void saveItem() throws Exception {
        ...
        itemFormDto.setItemPrice(1000);
        itemFormDto.setItemStock(100);
        ...
        assertEquals(itemFormDto.getItemPrice(), item.getItemPrice());
        assertEquals(itemFormDto.getItemStock(), item.getItemStock());
